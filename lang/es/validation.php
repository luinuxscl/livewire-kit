...
return [
    ...
    */
    ...
    | usando la convención "atributo.regla" para nombrar las líneas. Esto
    | facilita especificar una línea de lenguaje personalizada para una
    ...
    */
    ...
    | marcador de posición de atributo por algo más comprensible como
